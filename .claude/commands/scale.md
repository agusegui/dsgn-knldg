...
Read `knowledge/foundations/math.md` for the full ratio table, scale derivation method, spatial token system, and measure guidance.

Read `knowledge/typography/typesetting.md` for context-specific scale presets (Editorial, Product UI, Brand/Landing Page, Mobile).
